...
$version = MyInvois::documentType()->params(['id' => 1, 'vid' => '1.0'])->version();
...
$successfulRequests = MyinvoisRequest::where('http_code', 200)->get();
```

#### MyinvoisDocument

Model for storing submitted documents:

```php
use Laraditz\MyInvois\Models\MyinvoisDocument;

// Get all documents
$documents = MyinvoisDocument::all();
